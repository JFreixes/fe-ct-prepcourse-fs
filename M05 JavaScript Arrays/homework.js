...
function numeroMasGrande(arrayOfNums) {
   ...
   // Tu código:
// var referencia = arrayOfNums[0]
// for(let i =0; i<arrayOfNums.length; i++){
//    if(referencia < arrayOfNums[i] ) {
//       referencia = arrayOfNums[i]}
// } return referencia
for(let i =0; i<arrayOfNums.length; i++){
...
function cuentoElementos(array) {
   ...
   // Tu código:
  var arreglo = array.filter((num)=> num>18)
...
function mesesDelAño(array) {
  ...
  for(let i = 0; i<array.length; i++){
   ...
   } else if  (eneroMarzoNoviembre.length=== 3) { return eneroMarzoNoviembre}
...
function continueStatement(num) {
   ...
   for (let i = 0; i<10; i++){
       if (i===5){
continue} else{suma = suma + 2;}  nuevoArreglo.push(suma)
} return nuevoArreglo
}    
